...
voxel_vae_config = VoxelTokenizerConfig(
    enc_pretrained="../pretrained_models/trellis/ckpts/ckpts/ss_enc_conv3d_16l8_fp16",
    dec_pretrained="../pretrained_models/trellis/ckpts/ckpts/ss_dec_conv3d_16l8_fp16",
