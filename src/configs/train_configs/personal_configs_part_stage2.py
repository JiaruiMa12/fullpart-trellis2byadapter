...
voxel_vae_config = VoxelTokenizerConfigStage2(
    enc_pretrained="../pretrained_models/trellis/ckpts/ckpts/slat_enc_swin8_B_64l8_fp16",
    dec_pretrained="../pretrained_models/trellis/ckpts/ckpts/slat_dec_mesh_swin8_B_64l8m256c_fp16",
    dec_gs_pretrained="../pretrained_models/trellis/ckpts/ckpts/slat_dec_gs_swin8_B_64l8gs32_fp16",
...
# Check if Stage2 pipeline is available (requires nvdiffrast)
# JointDiTSingle3DPipelineConfigStage2 is already imported via `from ...pipelines import *`

# 3dmaster
if JointDiTSingle3DPipelineConfigStage2 is not None:
